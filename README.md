...
This project contains the adapter for using Vert.x as the low level transport the MongoDB Asynchronous Java Driver. It also contains the MongoDB persistor with the same API as [mod-mongo-persitor](https://github.com/vert-x/mod-mongo-persistor).
