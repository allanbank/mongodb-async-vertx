...
public class VertxTransportFactory implements TransportFactory {
     ...
     *            The {@link Vertx} instance.
     */
    public VertxTransportFactory(Vertx vertx) {
        myVertx = vertx;
    }
     ...
     */
    @Override
    public VertxTransport createTransport(Server server,
     ...
     */
    protected NetClient createNetClient(MongoClientConfiguration config) {

        NetClient netClient = myVertx.createNetClient();
